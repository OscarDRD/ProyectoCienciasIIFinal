...
class IndicesView(QtW.QGroupBox):
    def __init__(self, p: QWidget):
        ...
        self.setStyleSheet("background-color:#4DD0E1; "+
        ...
        self.bnReiniciar.setStyleSheet("QPushButton{background-color:#EF9A9A; color: black;}"
                                        "QPushButton::hover{background-color :#D50000; color: white;}"
                                        "QPushButton::pressed{background-color:#F44336; }")
        ...
        self.consola.setStyleSheet("background-color:#E6E401;")
